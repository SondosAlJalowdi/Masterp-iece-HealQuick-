            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="category">The 5 most recent service bookings</p>
                    </div>
                            ...
                            <tbody>
                                @forelse ($latestBookings as $index => $booking)
                                    <tr>
                                        ...
                                        <td>{{ $booking->organization->name ?? 'N/A' }}</td>
                                        <td>{{ $booking->booking_time ? \Carbon\Carbon::parse($booking->booking_time)->format('M d, Y H:i') : '-' }}</td>
                                    </tr>
                                @empty
                                    <tr>
