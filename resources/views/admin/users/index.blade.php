            ...
            <div class="col-md-12">
                <div class="card" style="border-radius: 12px; overflow: hidden;">
                    ...
                    <div class="header clearfix"
                        ...
                        <a href="{{ route('users.create') }}" class="btn btn-emerald"
                        ...
                        <form method="GET" action="{{ route('users.index') }}" class="form-inline">
                            <div class="form-group" style="margin-right: 10px;">
                                <input type="text" name="search" class="form-control input-sm"
                                    placeholder="Search by name or email..." style="width: 200px; border-radius: 3px;"
                            ...
                            <div class="form-group" style="margin-right: 10px;">
                                <select name="role" class="form-control input-sm"
                                    ...
                                    <option value="organization_admin"
                                        {{ request('role') == 'organization_admin' ? 'selected' : '' }}>Organization Admin
                                    </option>
                    ...
                    <div class="content" style="padding: 25px;">
                        @if (session('success'))
                            <div class="alert alert-emerald alert-dismissible fade show"
                        ...
                        @if ($users->isEmpty())
                            <div class="text-center py-5"
                                ...
                                <i class="fas fa-users-slash"
                                    style="font-size: 48px; color: #d1d9e6; margin-bottom: 20px;"></i>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card card-user"
                                            ...
                                            <div class="card-header"
                                                style="background-color: #f8f9fa;; color: black; padding: 20px; position: relative;">
                                                <!-- User Avatar/Image -->
                                                <div class="user-avatar"
                                                    style="width: 70px; height: 70px; background-color: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; overflow: hidden;">
                                                    @if ($user->image)
                                                        @php
                                                        ...
                                                        @endphp
                                                        <img src="{{ asset($imgUrl) }}" alt="{{ $imgUrl }}"
                                                            style="width: 100%; height: 100%; object-fit: cover;">
                                                    @elseif($user->organization && $user->organization->logo)
                                                        @php
                                                            if (
                                                                str_starts_with($user->organization->logo, 'storage/')
                                                            ) {
                                                                $logoUrl = Storage::url(
                                                                    str_replace(
                                                                        'storage/',
                                                                ...
                                                                file_exists(public_path($user->organization->logo))
                                                            ) {
                                                        ...
                                                        @endphp
                                                        <img src="{{ asset($logoUrl) }}" alt="{{ $logoUrl }}"
                                                            style="width: 100%; height: 100%; object-fit: cover;">
                                                    @else
                                                ...
                                                <div class="role-badge" style="position: absolute; top: 15px; right: 15px;">
                                                    <span
                                                        class="badge badge-{{ $user->role === 'admin' ? 'emerald-light' : ($user->role === 'organization_admin' ? 'emerald-dark' : 'emerald') }}"
                                                        style="border-radius: 12px; padding: 5px 12px; font-size: 12px; font-weight: 500;">
                                                        {{ ucfirst($user->role) }}
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-footer"
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <a href="{{ route('users.show', $user) }}"
                                                        ...
                                                        style="border-radius: 20px; padding: 5px 15px; font-size: 12px;">
                                                    ...
                                                    <form action="{{ route('users.destroy', $user) }}" method="POST"
                                                        ...
                                                        <button type="submit" class="btn btn-sm btn-outline-danger"
                                                            style="border-radius: 20px; padding: 5px 15px; font-size: 12px; border-color: #e74c3c; color: #e74c3c;">
