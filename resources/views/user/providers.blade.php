        ...
        <form method="GET" class="mb-4 bg-light p-3 rounded shadow-sm border">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    <button type="submit" class="btn text-white mr-2" style="background-color: #178066"><i
                            class="fa-solid fa-filter mr-2"></i> Filter</button>
                    <a href="{{ route('get.providers', $service->name) }}" class="btn btn-outline-primary"><i
                            class="fa-solid fa-rotate-right mr-2"></i> Reset</a>
                </div>
            </div>
        </form>
                                    ...
                                    @if ($organization->logo)
                                        @php
                                            if (str_starts_with($organization->logo, 'storage/')) {
                                                $logoUrl = Storage::url(
                                                    str_replace('storage/', '', $organization->logo),
                                                );
                                            }
